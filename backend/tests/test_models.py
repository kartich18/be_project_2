...
class TestTransactionModel:
    ...
    def test_to_dict_keys_complete(self, session):
        ...
        expected_keys = {
            ...
            "crypto_method", "key_gen_time_ms", "encapsulate_time_ms",
            "encrypt_time_ms", "decapsulate_time_ms", "decrypt_time_ms",
            "total_time_ms", "key_size_bytes", "secret_key_bytes",
            "ciphertext_size_bytes", "latency_bucket", "failure_reason",
            "origin_ip", "status",
        }
