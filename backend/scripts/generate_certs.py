...
DEPRECATION NOTICE: This script is deprecated and should not be used for production. 
It generates self-signed certificates which browsers do not trust.
For production deployments, please refer to docs/DEPLOYMENT.md for setup instructions
using Let's Encrypt and Certbot with Nginx.
