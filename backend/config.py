...
class Config:
    ...
    ADMIN_ACCESS_CODE = os.environ.get("ADMIN_CODE", "ADMIN123")
    VIEWER_ACCESS_CODE = os.environ.get("VIEWER_CODE", "VIEWER123")
    ...
    # ── TLS ───────────────────────────────────────────────────────────────
    TLS_CERT = os.path.join(BASE_DIR, "..", "infra", "certs", "cert.pem")
    TLS_KEY  = os.path.join(BASE_DIR, "..", "infra", "certs", "key.pem")
